      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              <h5 class="title">Transportation</h5>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              <h5 class="title">Supply chain management:</h5>
              <p class="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              <h5 class="title">Expedited shipping</h5>
              <p class="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              <h5 class="title">Last-mile delivery</h5>
              <p class="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              <h5 class="title">Freight forwarding</h5>
              <p class="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
