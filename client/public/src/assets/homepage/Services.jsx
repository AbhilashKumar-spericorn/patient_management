      ...
      <div className="row">
        <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div className="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div className="content mt-4">
              <h5 className="title">Transportation</h5>
        ...
        <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div className="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div className="content mt-4">
              <h5 className="title">Expedited shipping</h5>
              <p className="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
        ...
        <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div className="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div className="content mt-4">
              <h5 className="title">Last-mile delivery</h5>
              <p className="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
        ...
        <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
          <div className="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div className="content mt-4">
              <h5 className="title">Freight forwarding</h5>
              <p className="text-muted mt-3 mb-0">
                It is a long established fact that a reader will be distracted
                by the when looking at its layout.
              </p>
